...
LEARN_SUMMARY: [1-2 sentence description of what this task accomplished]
LEARN_WHAT_WORKED: [What approach/decision succeeded and why]
LEARN_WHAT_FAILED: [What failed or was suboptimal, or "Nothing"]
LEARN_INSIGHT: [Reusable lesson — what to do differently, stated as a principle]
...
| **Empty or vague LEARN phase** | No structured learning captured. Use LEARN_SUMMARY, LEARN_WHAT_WORKED, LEARN_WHAT_FAILED, LEARN_INSIGHT, LEARN_CATEGORY fields. |
...
### v0.2.25 (2026-02-07)
- **Structured LEARN Phase** — LEARN phase now requires five structured fields: LEARN_SUMMARY, LEARN_WHAT_WORKED, LEARN_WHAT_FAILED, LEARN_INSIGHT, LEARN_CATEGORY. These are parsed by TranscriptParser and captured as populated learning files instead of N/A templates. Added to Common Failures: empty/vague LEARN phase.
